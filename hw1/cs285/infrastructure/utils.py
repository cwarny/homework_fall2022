...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False):
    ...
    """
    # `min_timesteps_per_batch` is the total number of steps across all 
    # paths in the batch
    # `max_path_length` is the max number of steps in a single path
    # a batch will consist in a number of paths such that the total steps
    # across those paths exceeds `min_timesteps_per_batch`
